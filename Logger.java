...
public class Logger {
    ...
    static {
        ...
        int default_level = getLevel(properties.getProperty(".level"), ALL);

        default_console_level = getLevel(properties.getProperty(".console.level"), INFO);
        default_console_level = Math.max(default_console_level, default_level);
        default_file_level = getLevel(properties.getProperty(".file.level"), OFF);
    ...
    /**
     * Crea un logger.
     * Se trata de que para cada nombre el logger sea œnico.
     *
